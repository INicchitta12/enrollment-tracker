...
**Editions processed (5):** Dec 2025, Jan 2026, Feb 2026, Mar 2026, Apr 2026.
**Dashboard data window (Medicaid & CHIP):** Dec 2025 – Apr 2026. A caveat is *Active* if it
...
Issues touching data currently in the dashboard (Dec 2025 – Apr 2026).
...
| **Rhode Island** | Applications received | Could not report applications. | Dec 2024 – Jan 2025 | Applications data not shown in dashboard. | Dec 2025 – Apr 2026 (all) |
...
| **New York** | Applications received | Methodology change to include additional applications required by CMS specs. | Jul 2024 forward | Applications data not shown in dashboard. | Dec 2025 – Apr 2026 (all) |
